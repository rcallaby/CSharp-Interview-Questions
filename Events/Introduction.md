...
### Table of Contents
- [Q1. What is an event in C# and how does it work?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Events/EV-Question01.md)
- [Q2. Can you give an example of how to declare and raise an event in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Events/EV-Question02.md)
- [Q3. What is a delegate in C# and how is it related to events?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Events/EV-Question03.md)
- [Q4. How can you subscribe and unsubscribe to an event in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Events/EV-Question04.md)
- [Q5. Can you explain the difference between an event and a delegate in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Events/EV-Question05.md)