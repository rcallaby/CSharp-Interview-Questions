...
### Table of Contents
- [Q1. What is a generic type in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Generic-Types/GT-Question01.md)
- [Q2. How can you create a generic class in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Generic-Types/GT-Question02.md)
- [Q3. Can you explain the difference between a generic class and a non-generic class in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Generic-Types/GT-Question03.md)
- [Q4. What are the benefits of using generic types in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Generic-Types/GT-Question04.md)
- [Q5. Can you give an example of a generic method in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Generic-Types/GT-Question05.md)
- [Q6. What are the restrictions for using generic types in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Generic-Types/GT-Question06.md)
- [Q7. How can you create a generic interface in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Generic-Types/GT-Question07.md)
- [Q8. Can you explain the concept of type constraints in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Generic-Types/GT-Question08.md)
- [Q9. How can you implement generic algorithms in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Generic-Types/GT-Question09.md)
