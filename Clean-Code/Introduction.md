...
+ [Q1. What is the importance of writing clean code in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Clean-Code/CC-Question01.md)
+ [Q2. Can you explain the SOLID principles of object-oriented programming and how they can be applied to C# code?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Clean-Code/CC-Question02.md)
+ [Q3. What are some best practices for naming conventions in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Clean-Code/CC-Question03.md)
+ [Q4. How can you write maintainable and scalable code in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Clean-Code/CC-Question04.md)
+ [Q5. Can you give an example of how to write self-explanatory code in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Clean-Code/CC-Question05.md)
+ [Q6. How can you write code that is easy to understand for others in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Clean-Code/CC-Question06.md)
+ [Q7. What is the role of comments in writing clean code in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Clean-Code/CC-Question07.md)
+ [Q8. Can you explain the difference between writing procedural and object-oriented code in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Clean-Code/CC-Question08.md)
+ [Q9. How can you write code that follows the DRY (Don't Repeat Yourself) principle in C#?](https://github.com/rcallaby/CSharp-Interview-Questions/blob/main/Clean-Code/CC-Question09.md)
